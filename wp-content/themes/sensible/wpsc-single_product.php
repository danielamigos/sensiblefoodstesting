...
<div id="single_product_page_container">
    ...
    <div class="single_product_display group">
            ...
            <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="imagecol">
                                ...
                                <?php if (wpsc_the_product_thumbnail()) : ?>
                                    <a rel="<?php echo wpsc_the_product_title(); ?>"
                                       class="<?php echo wpsc_the_product_image_link_classes(); ?>" data-rel="lightbox"
                                       href="<?php echo esc_url(wpsc_the_product_image()); ?>">
                                        <img class="product_image"
                                             ...
                                             src="<?php echo esc_url(wpsc_the_product_image()); ?>"/>
                                    </a>
                                    <?php
                                ...
                                <?php else: ?>
                                    <a href="<?php echo esc_url(wpsc_the_product_permalink()); ?>">
                                        <img class="no-image" id="product_image_<?php echo wpsc_the_product_id(); ?>"
                ...
                <div class="col-md-6 green-dots-vertical">
                    <div class="productcol" style="margin-left:50px; margin-right:30px;">
                        ...
                        <div class="product-generic-title green-dots-bottom">
                            All-Natural Crunch Dried Snacks
                        </div>
                        <div class="sensible-product-title">
                        ...
                        <div class="sensible-price-product">
                            <?php if (wpsc_show_stock_availability()): ?>
                                <?php if (wpsc_product_has_stock()) : ?>
                                    <div id="stock_display_<?php echo wpsc_the_product_id(); ?>"
                                         class="in_stock"><?php _e('Product in stock', 'wpsc'); ?></div>
                                <?php else: ?>
                                    <div id="stock_display_<?php echo wpsc_the_product_id(); ?>"
                                         class="out_of_stock"><?php _e('Product not in stock', 'wpsc'); ?></div>
                                <?php endif; ?>
                            <?php endif; ?>
                            <?php if (wpsc_product_is_donation()) : ?>
                                <label
                                    for="donation_price_<?php echo wpsc_the_product_id(); ?>"><?php _e('Donation', 'wpsc'); ?>
                                    : </label>
                                <input type="text" id="donation_price_<?php echo wpsc_the_product_id(); ?>"
                                       name="donation_price"
                        ...
                        <?php if (wpsc_have_custom_meta()) : ?>
                            <div class="custom_meta" style="display:none;">
                                <?php while (wpsc_have_custom_meta()) : wpsc_the_custom_meta(); ?>
                                    <?php if (stripos(wpsc_custom_meta_name(), 'g:') !== FALSE) continue; ?>
                                    <strong><?php echo wpsc_custom_meta_name(); ?>
                                    : </strong><?php echo wpsc_custom_meta_value(); ?><br/>
                                <?php endwhile; ?>
                        ...
                        <form class="product_form" enctype="multipart/form-data"
                              action="<?php echo esc_url(wpsc_this_page_url()); ?>" method="post" name="1"
                            ...
                            <?php if (wpsc_have_variation_groups()) { ?>
                                <fieldset>
                                    <legend
                                        class="wpsc_variation_forms"><?php _e('Product Options', 'wpsc'); ?></legend>
                                    <div class="wpsc_variation_forms">
                                        <table>
                                            <?php while (wpsc_have_variation_groups()) : wpsc_the_variation_group(); ?>
                                                <tr>
                                                    <td class="col1"><label
                                                            for="<?php echo wpsc_vargrp_form_id(); ?>"><?php echo wpsc_the_vargrp_name(); ?>
                                                            :</label></td>
                                                    <?php /** the variation HTML and loop */ ?>
                                                    <td class="col2"><select class="wpsc_select_variation"
                                        ...
                                        <div id="variation_display_<?php echo wpsc_the_product_id(); ?>"
                                             class="is_variation"><?php _e('Combination of product variants is not available', 'wpsc'); ?></div>
                                    </div>
                            ...
                            <?php if ((get_option('hide_addtocart_button') == 0) && (get_option('addtocart_or_buynow') != '1')) : ?>
                                <?php if (wpsc_product_has_stock()) : ?>
                                    <div class="sensible-buy-button-container">
                                        <?php if (wpsc_product_external_link(wpsc_the_product_id()) != '') : ?>
                                            <?php $action = wpsc_product_external_link(wpsc_the_product_id()); ?>
                                            <input class="wpsc_buy_button" type="submit"
                        ...
                        <div class="sensible-product-description">
                        ...
                        if (wpsc_show_fb_like()): ?>
                            <div class="FB_like">
                                <iframe
                                    src="https://www.facebook.com/plugins/like.php?href=<?php echo wpsc_the_product_permalink(); ?>&amp;layout=standard&amp;show_faces=true&amp;width=435&amp;action=like&amp;font=arial&amp;colorscheme=light"
        ...
        <form onsubmit="submitform(this);return false;" action="<?php echo esc_url(wpsc_this_page_url()); ?>"
              method="post" name="product_<?php echo wpsc_the_product_id(); ?>"
