...
<div class="wrapper">
    <header
        class="header clear <?PHP if (is_front_page() || (get_post_type() == 'product_description' && is_single()) || (basename(get_page_template()) == 'template-large-header.php')) echo 'front-page product-description'; else echo 'page'; ?>"
        role="banner">

        <nav class="navbar navbar-default navbar-static-top <?php echo get_page_uri() == 'shop' ? 'shop' : '' ?>">
            <div class="container">
                        ...
                        <div class='site-logo hidden-sm'>
                            <a href='<?php echo esc_url(home_url('/')); ?>'
                               title='<?php echo esc_attr(get_bloginfo('name', 'display')); ?>' rel='home'><img
                                    src='<?php echo esc_url(get_theme_mod('sensible_logo')); ?>'
        ...
        <div class="social-icons" style="">
            ...
            $facebook_social_link = get_field('facebook_social_link', 'option');
            $instagram_social_link = get_field('instagram_social_link', 'option');
            if ($twitter_social_link != ''):
                ?>
                <a href="<?PHP echo $twitter_social_link; ?>" target="_blank"><img
                        src="<?php echo get_template_directory_uri(); ?>/img/social-icons/sf-icon-twitter.png"
                        alt="Twitter" style="width:32px;"/></a>
            <?PHP endif;
            if ($facebook_social_link != ''): ?>
                <a href="<?PHP echo $facebook_social_link; ?>" target="_blank"><img
                        src="<?php echo get_template_directory_uri(); ?>/img/social-icons/sf-icon-facebook.png"
                        alt="Facebook" style="width:32px;"/></a>
            <?PHP endif;
            if ($instagram_social_link != ''): ?>
                <a href="<?PHP echo $instagram_social_link; ?>" target="_blank"><img
                        src="<?php echo get_template_directory_uri(); ?>/img/social-icons/sf-icon-instagram.png"
                        alt="Instagram" style="width:32px;"/></a>
            <?PHP endif; ?>
        </div>
        ...
        <?php if (is_front_page()): ?>
                        ...
                        <div class="col-md-3" style="text-align:center; height:100%;vertical-align:middle; ">
                            ...
                            if (have_rows('slideshowrepeater', 'option')):
                                while (have_rows('slideshowrepeater', 'option')) : the_row(); ?>
                                    ...
                                    <div
                                        class="catapult-slideshow-text" <?PHP if ($slideCounter != 0) echo 'style="display:none;"'; ?>
                                        data-index="<?PHP echo $slideCounter; ?>">
                    ...
                    if (have_rows('slideshowrepeater', 'option')):
                        while (have_rows('slideshowrepeater', 'option')) : the_row();
                            ...
                            <div class="catapult-slide">
                                <img
                                    src="<?php echo get_sub_field('slideshowimage')['url']; //echo get_sub_field('slideshowimage')['sizes']['bootstrap-xl']; ?>"
            ...
            <script type="text/javascript">
                ...
                jQuery(document).ready(function ($) {
                    ...
                    $('#catapultSlidesHolder').click(function () {
                        NextSlide();
                    });
                        ...
                        <div class="row">
                            <div class="col-md-6" style="text-align:right;">
                                ...
                                <div style="margin-left:32%;">
                                    <div class="claims-checkmarks" style="text-align:left;">
                                    ...
                                    if (!empty($link)):
                                        ...
                                        <a href="<?PHP echo $link; ?>" class=""
                                           style="background-color:<?php the_field('productdescriptionfontcolor'); ?>; border-radius: 2px; padding:15px 20px; color:#ffffff; font-size:22px;">BUY
                                            NOW</a>
                                    <?PHP endif; ?>
                                </div>
                                -->
        ...
        <?PHP else: ?>
            <div class="page-background">
                <?php if (get_field('pagebackgroundheader'))    : ?>

                    <img src="<?PHP echo get_field('pagebackgroundheader')['sizes']['bootstrap-xl-header']; ?>" alt="">

                <?php else: ?>
                    <img src="http://sensiblefoods.net/wp-content/uploads/2015/06/sf-recipes-header-1500x200.jpg"
                         alt="">
                <?php endif; ?>
            </div>
        <?PHP endif; ?>
    ...
    <?PHP if (is_front_page()):
        $secondary_menu_1_title = get_field('secondary_menu_1_title', 'option');
        $secondary_menu_1_url = get_field('secondary_menu_1_url', 'option');
        $secondary_menu_2_title = get_field('secondary_menu_2_title', 'option');
        $secondary_menu_2_url = get_field('secondary_menu_2_url', 'option');
        $secondary_menu_3_title = get_field('secondary_menu_3_title', 'option');
        $secondary_menu_3_url = get_field('secondary_menu_3_url', 'option');
        ?>
        <div class="secondary-menu">
            <div class="container">
                <div class="row">
                    <div class="col-md-4" style="text-align:center;margin: 5px 0;">
                        <a href="<?PHP echo $secondary_menu_1_url; ?>" class="icon-link" style="line-height: 60px;">
                            <div class="icon-sprite"
                                 style="background-image:url(<?php echo get_template_directory_uri(); ?>/img/sf-icon-shop.png); vertical-align:middle; margin-right:15px;"></div>
                            <?PHP echo $secondary_menu_1_title; ?>
                        </a>
                    </div>
                    <div class="col-md-4" style="text-align:center;margin: 5px 0;">
                        <a href="<?PHP echo $secondary_menu_2_url; ?>" class="icon-link" style="line-height: 60px;">
                            <div class="icon-sprite"
                                 style="background-image:url(<?php echo get_template_directory_uri(); ?>/img/sf-icon-recipes.png); vertical-align:middle; margin-right:15px;"></div>
                            <?PHP echo $secondary_menu_2_title; ?>
                        </a>
                    </div>
                    <div class="col-md-4" style="text-align:center;margin: 5px 0;">
                        <a href="<?PHP echo $secondary_menu_3_url; ?>" class="icon-link" style="line-height: 60px;">
                            <div class="icon-sprite"
                                 style="background-image:url(<?php echo get_template_directory_uri(); ?>/img/sf-icon-newsletter.png); vertical-align:middle; margin-right:15px;"></div>
                            <?PHP echo $secondary_menu_3_title; ?>
                        </a>
                    </div>
                </div>
            </div>
