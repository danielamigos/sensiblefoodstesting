                        ...
                        <?php while (wpsc_have_products()) {
                            ...
                            <div class="col-md-3" style="">
                                <div class="product_grid_item product_view_<?php echo wpsc_the_product_id(); ?>"
                                    ...
                                    <?php if (wpsc_the_product_thumbnail()) { ?>
                                        <div class="item_image" style="margin-top:20px; margin-bottom:15px;">
                                            <a href="<?php echo wpsc_the_product_permalink(); ?>">
                                                <img style="height:300px" class="product_image"
                                    ...
                                    <?php if (wpsc_product_on_special()) { ?><span
                                        class="sale"><?php _e('Sale', 'wpsc'); ?></span><?php } ?>
                                    <?php if (get_option('show_images_only') != 1) { ?>
                                        <div class="grid_product_info">
                                            ...
                                            <div class="price_container">
                                                ...
                                                <?php if (wpsc_show_pnp()) { ?>
                                                    <p class="pricedisplay"><?php _e('Shipping', 'wpsc'); ?>:<span
                                        ...
                                        <div class="grid_more_info">
                                            <form class="product_form" enctype="multipart/form-data"
                                                ...
                                                <input type="hidden" value="<?php echo wpsc_the_product_id(); ?>"
                                                       name="product_id"/>
                                                    ...
                                                    <?php if (wpsc_have_variation_groups()) { ?>
                                                        <fieldset>
                                                            ...
                                                            <div class="wpsc_variation_forms">
                                                                ...
                                                                <div
                                                                    id="variation_display_<?php echo wpsc_the_product_id(); ?>"
                                                    ...
                                                    <?php if (wpsc_product_has_stock()) { ?>
                                                        ...
                                                        if (get_option('display_variations') != 1 && wpsc_product_has_variations(wpsc_the_product_id())) {
                                                            ...
                                                            <input type="submit"
                                                                   ...
                                                                   name="Buy" class="wpsc_buy_button"
